...
<template>
    <AppLayout>
        <div class="information">
            <h1 class="information-title">URL Shortener</h1>
            <p class="information-description">
                Generate a short url from your url.
            </p>
        </div>
        <section class="section">
            <UrlShortenerForm />
        </section>
        <section v-if="$page.props.flash.shortUrl" class="section">
            <UrlShortenerResult />
        </section>
    </AppLayout>
</template>
...
.information {
    ...
    .information-title {
        font-size: 2.4rem;
        text-shadow: 4px 4px var(--box-shadow-color);
    }

    .information-description {
        font-size: 1.2rem;
        text-shadow: 3px 3px var(--box-shadow-color);
    }
}
